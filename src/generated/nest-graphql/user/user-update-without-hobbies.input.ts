...
import { DealUpdateManyWithoutSavedUsersNestedInput } from '../deal/deal-update-many-without-saved-users-nested.input';
...
export class UserUpdateWithoutHobbiesInput {
    ...
    savedDeals?: DealUpdateManyWithoutSavedUsersNestedInput;
