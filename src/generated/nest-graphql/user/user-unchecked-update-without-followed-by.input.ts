...
import { ProductListingUncheckedUpdateManyWithoutUploaderNestedInput } from '../product-listing/product-listing-unchecked-update-many-without-uploader-nested.input';
...
export class UserUncheckedUpdateWithoutFollowedByInput {
    ...
    productListings?: ProductListingUncheckedUpdateManyWithoutUploaderNestedInput;
