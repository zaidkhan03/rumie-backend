...
import { ProductReportCreateNestedManyWithoutReporterInput } from '../product-report/product-report-create-nested-many-without-reporter.input';
...
export class UserCreateWithoutWishlistInput {
    ...
    reportedProducts?: ProductReportCreateNestedManyWithoutReporterInput;
