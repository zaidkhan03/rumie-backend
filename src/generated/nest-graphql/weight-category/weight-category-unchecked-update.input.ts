...
import { ProductListingUncheckedUpdateManyWithoutWeightCategoryNestedInput } from '../product-listing/product-listing-unchecked-update-many-without-weight-category-nested.input';
...
export class WeightCategoryUncheckedUpdateInput {
    ...
    ProductListing?: ProductListingUncheckedUpdateManyWithoutWeightCategoryNestedInput;
}
