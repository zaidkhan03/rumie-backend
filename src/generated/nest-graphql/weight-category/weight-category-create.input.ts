...
import { ProductListingCreateNestedManyWithoutWeightCategoryInput } from '../product-listing/product-listing-create-nested-many-without-weight-category.input';
...
export class WeightCategoryCreateInput {
    ...
    ProductListing?: ProductListingCreateNestedManyWithoutWeightCategoryInput;
}
