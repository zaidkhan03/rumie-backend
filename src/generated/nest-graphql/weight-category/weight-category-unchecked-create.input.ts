...
import { ProductListingUncheckedCreateNestedManyWithoutWeightCategoryInput } from '../product-listing/product-listing-unchecked-create-nested-many-without-weight-category.input';
...
export class WeightCategoryUncheckedCreateInput {
    ...
    ProductListing?: ProductListingUncheckedCreateNestedManyWithoutWeightCategoryInput;
}
