...
import { ProductListingUpdateOneRequiredWithoutConversationsNestedInput } from '../product-listing/product-listing-update-one-required-without-conversations-nested.input';
import { UserUpdateManyWithoutConversationsNestedInput } from '../user/user-update-many-without-conversations-nested.input';
...
export class ConversationUpdateInput {
    ...
    product?: ProductListingUpdateOneRequiredWithoutConversationsNestedInput;
