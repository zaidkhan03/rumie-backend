...
import { EnumConversationTypeWithAggregatesFilter } from '../prisma/enum-conversation-type-with-aggregates-filter.input';
...
export class ConversationScalarWhereWithAggregatesInput {
    ...
    type?: EnumConversationTypeWithAggregatesFilter;

    @Field(() => StringNullableWithAggregatesFilter, {nullable:true})
    preferredPaymentMethod?: StringNullableWithAggregatesFilter;

    @Field(() => StringNullableWithAggregatesFilter, {nullable:true})
    preferredAddressId?: StringNullableWithAggregatesFilter;

    @Field(() => BoolNullableWithAggregatesFilter, {nullable:true})
    paymentLinkSent?: BoolNullableWithAggregatesFilter;

    @Field(() => BoolNullableWithAggregatesFilter, {nullable:true})
    deliveryConfirmedBySeller?: BoolNullableWithAggregatesFilter;

    @Field(() => IntNullableWithAggregatesFilter, {nullable:true})
    paymentLinkCount?: IntNullableWithAggregatesFilter;
