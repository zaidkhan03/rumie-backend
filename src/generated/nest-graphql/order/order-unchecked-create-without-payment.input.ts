...
import { SupportTicketUncheckedCreateNestedManyWithoutConcernedOrderInput } from '../support-ticket/support-ticket-unchecked-create-nested-many-without-concerned-order.input';
...
export class OrderUncheckedCreateWithoutPaymentInput {
    ...
    supportTickets?: SupportTicketUncheckedCreateNestedManyWithoutConcernedOrderInput;
}
