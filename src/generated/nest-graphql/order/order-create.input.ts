...
import { PaymentCreateNestedOneWithoutOrderInput } from '../payment/payment-create-nested-one-without-order.input';
import { SupportTicketCreateNestedManyWithoutConcernedOrderInput } from '../support-ticket/support-ticket-create-nested-many-without-concerned-order.input';
...
export class OrderCreateInput {
    ...
    supportTickets?: SupportTicketCreateNestedManyWithoutConcernedOrderInput;
}
