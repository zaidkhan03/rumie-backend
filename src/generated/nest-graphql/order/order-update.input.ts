...
import { PaymentUpdateOneWithoutOrderNestedInput } from '../payment/payment-update-one-without-order-nested.input';
import { SupportTicketUpdateManyWithoutConcernedOrderNestedInput } from '../support-ticket/support-ticket-update-many-without-concerned-order-nested.input';
...
export class OrderUpdateInput {
    ...
    supportTickets?: SupportTicketUpdateManyWithoutConcernedOrderNestedInput;
}
