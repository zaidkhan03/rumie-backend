...
import { OrderCreateNestedOneWithoutSupportTicketsInput } from '../order/order-create-nested-one-without-support-tickets.input';
...
export class SupportTicketCreateInput {
    ...
    concernedOrder?: OrderCreateNestedOneWithoutSupportTicketsInput;
}
