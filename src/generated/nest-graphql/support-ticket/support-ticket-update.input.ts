...
import { OrderUpdateOneWithoutSupportTicketsNestedInput } from '../order/order-update-one-without-support-tickets-nested.input';
...
export class SupportTicketUpdateInput {
    ...
    concernedOrder?: OrderUpdateOneWithoutSupportTicketsNestedInput;
}
