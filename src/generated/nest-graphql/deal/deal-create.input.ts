...
import { UserCreateNestedManyWithoutSavedDealsInput } from '../user/user-create-nested-many-without-saved-deals.input';
...
export class DealCreateInput {
    ...
    savedUsers?: UserCreateNestedManyWithoutSavedDealsInput;
}
