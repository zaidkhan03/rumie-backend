...
import { UserUpdateManyWithoutSavedDealsNestedInput } from '../user/user-update-many-without-saved-deals-nested.input';
...
export class DealUpdateInput {
    ...
    savedUsers?: UserUpdateManyWithoutSavedDealsNestedInput;
}
