...
import { UserUncheckedUpdateManyWithoutWishlistNestedInput } from '../user/user-unchecked-update-many-without-wishlist-nested.input';
import { ConversationUncheckedUpdateManyWithoutProductNestedInput } from '../conversation/conversation-unchecked-update-many-without-product-nested.input';
import { ProductReportUncheckedUpdateManyWithoutProductNestedInput } from '../product-report/product-report-unchecked-update-many-without-product-nested.input';
...
export class ProductListingUncheckedUpdateWithoutUploaderEduInstituteInput {
    ...
    conversations?: ConversationUncheckedUpdateManyWithoutProductNestedInput;

    @Field(() => ProductReportUncheckedUpdateManyWithoutProductNestedInput, {nullable:true})
    reports?: ProductReportUncheckedUpdateManyWithoutProductNestedInput;
}
