...
import { BrandCreateNestedOneWithoutProductListingInput } from '../brand/brand-create-nested-one-without-product-listing.input';
...
export class ProductListingCreateWithoutReportsInput {
    ...
    brand?: BrandCreateNestedOneWithoutProductListingInput;
