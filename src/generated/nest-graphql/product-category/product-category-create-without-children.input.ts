...
import { ProductListingCreateNestedManyWithoutCategoryInput } from '../product-listing/product-listing-create-nested-many-without-category.input';
...
export class ProductCategoryCreateWithoutChildrenInput {
    ...
    productListings?: ProductListingCreateNestedManyWithoutCategoryInput;
}
