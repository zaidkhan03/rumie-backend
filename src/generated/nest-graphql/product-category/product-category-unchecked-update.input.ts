...
import { ProductCategoryUncheckedUpdateManyWithoutParentNestedInput } from './product-category-unchecked-update-many-without-parent-nested.input';
import { ProductListingUncheckedUpdateManyWithoutCategoryNestedInput } from '../product-listing/product-listing-unchecked-update-many-without-category-nested.input';
...
export class ProductCategoryUncheckedUpdateInput {
    ...
    productListings?: ProductListingUncheckedUpdateManyWithoutCategoryNestedInput;
}
